...
export default function Invoices() {
  ...
  return (
    <div className="mx-auto flex min-h-full w-full max-w-4xl flex-col items-center justify-center gap-8 p-16 dark:text-gray-50">
      <h1 className="text-4xl font-semibold">Create Items</h1>
        ...
        <div className="pt-4 lg:relative">
          {new Array(itemCount).fill("").map((_, i) => {
            ...
            return (
              <div
                key={i}
                className="flex flex-wrap items-center gap-4 pb-4 lg:block"
              >
                <div className="flex w-full flex-wrap items-center gap-4 lg:block">
                  <label
                    htmlFor={`item-${i}`}
                  ...
                  <input
                    type="text"
                    id={`item-${i}`}
                    className="flex-grow rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 lg:w-full"
                  />
                  {isLastButton && (
                    <>
                      <button
                ...
                <div className="w-full">
                  <label
                    htmlFor="description"
                    className="my-2 block text-sm font-medium text-gray-900 dark:text-gray-400"
                  >
                    Description
                  </label>
                  <textarea
